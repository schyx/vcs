...
pub fn get_line_in_file(filename: &str, line_num: usize) -> Result<String, Error> {
...
pub fn get_line_in_object(hash: &str, line_num: usize) -> Result<String, Error> {
...
pub fn clear_file_contents(path: &str) -> Result<(), Error> {
